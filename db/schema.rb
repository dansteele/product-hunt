...
ActiveRecord::Schema.define(version: 20151107135931) do
  ...
  add_index "governments", ["email"], name: "index_governments_on_email", unique: true, using: :btree
  add_index "governments", ["reset_password_token"], name: "index_governments_on_reset_password_token", unique: true, using: :btree
